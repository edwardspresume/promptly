 ...
 * @param {SupabaseClient<Database>} supabase Initialized Supabase client.
 * @param {SuperValidated<typeof tagsCrudSchema> | undefined} tagForm Form data validated against the tagsCrudSchema.
...
const handleTagOperation = async (
    ...
    session: Session,
    supabase: SupabaseClient<Database>,
    tagForm?: SuperValidated<typeof tagsCrudSchema>,
    tagId?: string | null
) => {
