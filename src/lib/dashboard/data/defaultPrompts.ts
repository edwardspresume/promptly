...
const defaultPrompts: PromptSchema[] = [
	...
	createPrompt('Spanish for Beginners', "Generate a beginner's guide to conversational Spanish."),
	createPrompt(
		'Reviewing "1984"',
		"Write an insightful review of the dystopian novel '1984' by George Orwell."
	),
	createPrompt('30-Day Fitness Challenge', 'Design a 30-day fitness plan aimed at weight loss.'),
	createPrompt(
